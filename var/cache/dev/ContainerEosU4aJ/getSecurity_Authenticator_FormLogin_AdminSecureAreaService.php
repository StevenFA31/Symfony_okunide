 ...
 */
class getSecurity_Authenticator_FormLogin_AdminSecureAreaService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.authenticator.form_login.admin_secure_area' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authenticator.form_login.admin_secure_area'])) {
            return $container->privates['security.authenticator.form_login.admin_secure_area'];
        }
        ...
        $c->setOptions(['login_path' => 'admin_login', 'default_target_path' => 'app_admin', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false]);
        $c->setFirewallName('admin_secure_area');
        ...
        return $container->privates['security.authenticator.form_login.admin_secure_area'] = new \Symfony\Component\Security\Http\Authenticator\FormLoginAuthenticator($b, ($container->privates['security.user.provider.concrete.app_admin_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppAdminProviderService')), $c, $d, ['login_path' => 'admin_login', 'check_path' => 'admin_login', 'username_parameter' => 'login[email]', 'password_parameter' => 'login[password]', 'enable_csrf' => true, 'use_forward' => false, 'require_previous_session' => false, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true, 'form_only' => false]);
    }
}
