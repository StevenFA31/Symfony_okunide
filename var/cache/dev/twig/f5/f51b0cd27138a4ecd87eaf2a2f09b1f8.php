...
class __TwigTemplate_a69705fa1b36ada3b28d4f3b45da967b extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["genre"]) {
            ...
            echo "</td>
                <td>";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["genre"], "name", [], "any", false, false, false, 20), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_genre_show", ["id" => twig_get_attribute($this->env, $this->source, $context["genre"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 23
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_genre_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["genre"], "id", [], "any", false, false, false, 23)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
    ...
    <a href=\"";
        // line 34
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_genre_new");
        echo "\">Create new</a>
";
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for genre in genres %}
            <tr>
                ...
                <td>{{ genre.name }}</td>
                <td>
                    <a href=\"{{ path('app_genre_show', {'id': genre.id}) }}\">show</a>
    ...
    <a href=\"{{ path('app_genre_new') }}\">Create new</a>
{% endblock %}
", "genre/index.html.twig", "/home/stevenfa/Bureau/Serveur Docker/docker-compose-lamp/www/Projects/Projet_GitLab/SYMFONY_okunidé/templates/genre/index.html.twig");
    }
}
